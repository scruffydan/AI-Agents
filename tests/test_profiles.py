...
class ProfileResolverTests(unittest.TestCase):
    ...
    def test_resolves_default_opencode_profile(self) -> None:
        ...
        self.assertEqual(resolved.model, "openai/gpt-5.5")
    ...
    def test_resolves_work_profile(self) -> None:
        ...
        self.assertEqual(resolved.model, "google-vertex-anthropic/claude-opus-4-6")
        self.assertEqual(resolved.settings["reasoning_effort"], "medium")
    ...
    def test_harness_specific_settings_override_shared_defaults(self) -> None:
        profiles = {
            "example": {
                ...
                "default": {
                    "opencode": {"provider": "openai", "model": "gpt-5.5", "temperature": 0.8},
                },
            }
        }
    ...
    def test_opencode_provider_override_replaces_profile_provider(self) -> None:
        ...
        self.assertEqual(resolved.model, "github-copilot/gpt-5.5")
    ...
    def test_raises_on_missing_harness_entry(self) -> None:
        profiles = {"default": {"default": {"opencode": {"provider": "openai", "model": "gpt-5.5"}}}}
    ...
    def test_raises_on_invalid_shared_profile_settings(self) -> None:
        profiles = {
            "default": {"shared": "invalid", "default": {"opencode": {"provider": "openai", "model": "gpt-5.5"}}}
        }
    ...
    def test_raises_when_opencode_provider_is_missing(self) -> None:
        profiles = {"default": {"default": {"opencode": {"model": "gpt-5.5"}}}}
    ...
    def test_raises_when_opencode_model_uses_composed_string(self) -> None:
        profiles = {"default": {"default": {"opencode": {"provider": "openai", "model": "openai/gpt-5.5"}}}}
