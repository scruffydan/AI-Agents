...
This are the standard Claude Code instructions delivered by the IT department. This file should not be edited directly. See the bottom of this file if you want to add custom instructions.
...
NEVER READ SECRETS: You are FORBIDDEN from reading or asking to read any file listed in the .claude-code-ignore file.
